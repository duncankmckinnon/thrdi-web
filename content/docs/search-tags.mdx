...
| Flag | Effect |
|------|--------|
| `--platform NAME` | Only sessions from this platform (`claude`, `codex`, `cursor`, or `copilot`). |
...
Running parallel agents with workbench? See [Workbench integration](/docs/workbench) to generate plan, wave, task, role, and pipeline-step tags automatically.
