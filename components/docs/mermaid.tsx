...
export function Mermaid({ children, chart: chartProp }: MermaidProps) {
  const chart = (
    chartProp ?? Children.toArray(children).map(extractText).join("")
  ).trim();
      ...
      if (!mermaidInitialized) {
        mermaid.initialize({
          ...
          themeVariables: {
            ...
            primaryBorderColor: "#14b8b8",
            lineColor: "#94d8d8",
            secondaryColor: "#0f2a31",
