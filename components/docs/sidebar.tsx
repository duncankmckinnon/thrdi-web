...
function NavTree({
  ...
  const items = docs.filter((d) => (parentSlug ? d.parent === parentSlug : !d.parent));
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed bottom-4 right-4 z-50 bg-brand-accent-primary text-brand-bg-primary px-4 py-2 rounded-full shadow-lg font-medium"
      >
        {isOpen ? "Close" : "Menu"}
      </button>
