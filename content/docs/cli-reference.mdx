...
Persists the key and enables live export. Requires `pip install 'thrdi[logfire]'`.
...
Launch the local browser UI. Defaults to `http://127.0.0.1:8765` and auto-opens your default browser. Requires the `ui` extra (`pip install 'thrdi[ui]'`).
