...
```
thirdeye logfire enable --token <gateway-key> [--project NAME]
```
...
Shows whether the package is installed and whether export, token, project, and active state are configured.
...
Stops export while retaining the saved key and project.
