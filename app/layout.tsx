...
const siteDescription =
  "Local-first observability for Claude Code, Codex, Cursor, and Copilot. Keep traces on your filesystem, or mirror structured turn traces to Pydantic Logfire.";
